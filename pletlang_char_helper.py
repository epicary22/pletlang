...
class PletlangCharHelper:
    VALID_INTS = [char.value["int"] for char in PletlangChar]
    VALID_CHARS = [char.value["str"] for char in PletlangChar]
    ...
    @staticmethod
    def __to_interpretable_char(string: str) -> str:
        """
        ...
        if char_to_check not in [PletlangChar.VALID_STRS]:
            return ' '
        return char_to_check

    @staticmethod
    def to_pletlang_char_from_char(char: str) -> None | PletlangChar:
        """
